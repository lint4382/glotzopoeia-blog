<script module lang="ts">
	export const title = "Introducing Glotzopoeia";
	export const date = new Date("2026-05-19T22:59:07");
	export const blurb = "What am I doing? Who is this for? Find out NOW!";
</script>

<p>
	Glotzopoeia is an application for the curation of linguistic information, i.e. a dictionary-making
	app, that I am working on NOW!
</p>

<h2>Motivation, Vision, Scope</h2>

<details>
	<summary>TL;DR: Conlanging is uniquely hard and I'm a perfectionist.</summary>

	<p>
		Dictionaries defy the usual dichotomy and "hard data" and "soft knowledge" that most other
		curation apps are implicitly based on.
	</p>

	<ul>
		<li>
			<p>
				If you need to curate <em>hard data</em>, you can put it into an Excel spreadsheet or a
				relational database or a knowledge graph. You conform to a rigid structure, but in turn get
				the ability to sort and filter and aggregate your dataset however you feel like it.
			</p>
		</li>
		<li>
			<p>
				If you need to curate <em>soft knowledge</em>, you write a book or some interlinked wiki
				articles. This is much harder for computers to digest, but more flexible if you can't make
				the information conform to a rigid schema.
			</p>
		</li>
	</ul>

	<p>
		Dictionaries obviously benefit from being searched through in a "hard data" way. However, the
		art of conlanging defies formalization on many levels:
	</p>

	<ul>
		<li>
			<p>
				Words often fit into parts-of-speech, classes or conjugation paradigms, but just as often
				...
				accomplish (check Sylvia Sotomayor's excellent <a
					href="https://www.terjemar.net/kelen/Dict/dict0.php">Kēlen dictionary</a
				>, which was the original inspiration for this project, or
				<a href="https://la-lojban.github.io/sutysisku/lojban/index.html">la sutysisku</a>). If you
		...
		<li>
			<p>
				The usage of a word can never be exactly pinned down, because it's a product of the
		...
		<li>
			<p>
				It makes sense to want to document the conlang's grammar in the same framework as the
				...
				discounted as "out of scope".
			</p>
		</li>
	</ul>

	<p>
		It makes sense to ask if Glotzopoeia should even be called a conlanging app if its ambitions are
		...
		come once the primary use case is all sorted out.
	</p>
</details>
...
<ul>
	<li>
		<p>
			Glotzopoeia will use the cross-platform app framework Tauri, with a Rust backend and a Svelte
	...
	<li>
		<p>
			Glotzopoeia will be a desktop application. I might make a mobile port but that'll probably be
			a lot of work.
		</p>
	</li>
	<li>
		<p>
			Glotzopoeia saves all data as local XML files. I have designed a lightweight markup / data
			...
			constantly shift as I change my mind about things.
		</p>
	</li>
	<li>
		<p>
			The editing interface will be a hybrid of WYSIWYG and WYSIWYM, somewhat like Notion. The XML
			...
			intuitive / convenient one.
		</p>
	</li>
	<li>
		<p>Glotzopoeia will be open-source software licensed under GPLv3.</p>
	</li>
</ul>
...
<p>
	This has been my main pet project for multiple years, but I have basically started from complete
...
<p>
	I set up this blog yesterday. I will post updates whenever something significant happens. I can't
	make any promises that those updates will actually happen, or when they will happen, but I will
	try my best.
</p>

<p>
	The repo is at <a href="https://github.com/lint4382/glotzopoeia"
		>https://github.com/lint4382/glotzopoeia</a
	>.
</p>

<p>
	Discussions on the project take place on its Discord server. It's not open to the public for now,
